...
public class ModItems {
    ...
    public static final Item CUSTOMZOMBIESPAWNEGG = registerItem("customzombiespawnegg", settings -> new SpawnEggItem(ModEntities.CUSTOM_ZOMBIE, settings),  new Item.Settings());
